...
using ContactManager.WindowsStore.Models;
...
namespace ContactManager.WindowsStore.Data
{
    /// <summary>
    ...
    public abstract class SampleDataCommon : ContactManager.WindowsStore.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        /// <summary>
        /// Loads data asynchronously from a remote service.
        /// </summary>
        /// <param name="clear">If true, clears the sample data group before fetching new data.</param>
        /// <returns></returns>
